...
pub enum UpdateAction {
    /// Update via `npm install -g @duo121/codex-kanban@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @duo121/codex-kanban@latest`.
    BunGlobalLatest,
    /// Update via `brew upgrade --cask codex-kanban`.
    BrewUpgrade,
}
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@duo121/codex-kanban"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@duo121/codex-kanban"]),
            UpdateAction::BrewUpgrade => ("brew", &["upgrade", "--cask", "codex-kanban"]),
        }
    }
