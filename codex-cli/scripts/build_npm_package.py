#!/usr/bin/env python3
"""Stage and optionally package the @duo121/codex-kanban npm module."""
...
CODEX_NPM_NAME = "@duo121/codex-kanban"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@duo121/codex-kanban`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@duo121/codex-kanban-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@duo121/codex-kanban-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@duo121/codex-kanban-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@duo121/codex-kanban-darwin-arm64",
...
PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    ...
    "codex-win32-x64": ["codex", "codex-command-runner", "codex-windows-sandbox-setup", "rg"],
    "codex-win32-arm64": ["codex", "codex-command-runner", "codex-windows-sandbox-setup", "rg"],
